...
export default function AdminSidebar() {
    const navItems = [
        ...
        { label: "Housing Moderation", href: "/admin/housing", icon: "🏠" },
    ...
    return (
        <aside className="w-64 bg-slate-900 min-h-screen text-slate-300 flex flex-col fixed left-0 top-0 shadow-2xl z-20">
            ...
            <div className="p-6 border-b border-slate-800 flex items-center gap-4">
                <div className="relative w-10 h-10 rounded-xl overflow-hidden flex items-center justify-center bg-unizy-navy">
                ...
                <div>
                    ...
                    <p className="text-xs text-brand-400 font-medium">Control Center</p>
                </div>
            </div>
            ...
            <div className="p-4 m-4 bg-slate-800 rounded-2xl flex items-center justify-between border border-slate-700">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-white text-sm font-bold leading-tight">Admin User</p>
