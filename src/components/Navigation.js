...
export default function Navigation() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 sm:hidden z-50 bg-white/95 dark:bg-unizy-navy/95 backdrop-blur-md border-t border-gray-100 dark:border-unizy-dark pb-safe">
