            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-4 gap-6">
                    {[
                        ...
                        { label: 'Avg Response Time', value: '12m (mock)', color: 'text-amber-500' },
                        { label: 'Resolved Total', value: resolvedTotal, color: 'text-green-500' },
                        { label: 'CSAT Score', value: '4.8/5.0 (mock)', color: 'text-blue-500' },
                    ].map((stat, i) => (
