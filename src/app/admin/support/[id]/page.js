...
export default function AdminTicketDetailPage() {
    ...
    const handleSendMessage = async (e) => {
        ...
        setIsSending(true);
        const res = await sendTicketMessage({ ticketId: id, content: message, isAdmin: true });
                                    ...
                                    <div className={`max-w-[70%] rounded-3xl p-5 shadow-sm ${fromStaff
                                        ...
                                        <div className="flex items-center gap-2 mb-2">
                                            <span className="text-[10px] font-black uppercase tracking-widest opacity-60">
                                                {fromStaff ? 'You (Support)' : ticket.user.name}
                                            </span>
                                        </div>
                    ...
                    <div className="p-6 border-t border-gray-100 bg-white">
                        <form onSubmit={handleSendMessage} className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className="p-4 bg-unizy-primary text-white rounded-2xl shadow-lg shadow-unizy-primary/20 hover:scale-105 active:scale-95 transition-all disabled:opacity-50"
                            >
                                {isSending ? (
